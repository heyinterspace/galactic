        ...
        >
          ...
          >
            ...
            <p className="mb-6 text-[13px] leading-relaxed text-ink-dim">
              Cosmograph can map anyone with a public research record. Search
              for a name below and the entire universe rebuilds around their
              work — live, with nothing to install. Deep exploration of a custom
              researcher (Fly, Tour, and full paper details) is a one-time
              premium unlock.
            </p>
